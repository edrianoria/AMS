...
<body>
    ...
    ?>
        <div class="container">
            ...
            <div class="header">
                <h1 class="">Edit Student Attendance</h1>
            ...
            <div class="edit-content p-2">
                ...
                ?>
                        <form method="post" action="EditAttendance">
                            <fieldset class="p-2">
                                <legend>Student Information</legend>
                                <div class="mb-1">
                                    <input type="hidden" name="txtuser" value="<?= $this->session->userdata('id'); ?>">
                                    <input class="" type="text" name="txtsid" value="<?= $info['student_id'] ?>" disabled>
                                </div>
                                <div class="mb-1">
                                    <input class="" type="text" name="txtlname" value="<?= $info['lastname'] ?>" disabled>
                                </div>
                                <div class="mb-1">
                                    <input class="" type="text" name="txtfname" value="<?= $info['firstname'] ?>" disabled>
                                </div>
                                <div class="mb-1">
                                    <select class="select" name="gender">
                                        <option selected disabled><?= $info['gender'] ?></option>
                                        <option value="Male" disabled>Male</option>
                                        <option value="Female" disabled>Female</option>
                                    </select>
                                </div>
                                <div class="mb-1">
                                    <input class="" type="text" name="section" value="<?= $info['section'] ?>" disabled>
                                </div>
                                <div class="mb-1">
